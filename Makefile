...
LIBS = -L${SYSROOT}/usr/lib $(ARCH) -lSDL2_ttf -lSDL2_image -lSDL2_mixer -lSDL2 -lfreetype -lbz2 -ljpeg -lpng -lz -lpthread -lm
#removed -lmad
EXT_FLAGS =
else
DEFS = -DLINUX -DUSE_SDL_RENDERER -DNDEBUG -DMIYOO
INCS = `sdl2-config --cflags`
LIBS = `sdl2-config --libs` -lSDL2_image -lSDL2_ttf -lSDL2_mixer -ljpeg -lpng -lz -lbz2 -lm
EXT_FLAGS = 
 endif
